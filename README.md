# @hishprorg/est-qui-aperiam

[![npm version](https://img.shields.io/npm/v/@hishprorg/est-qui-aperiam.svg)](https://www.npmjs.com/package/@hishprorg/est-qui-aperiam)
[![Downloads/month](https://img.shields.io/npm/dm/@hishprorg/est-qui-aperiam.svg)](http://www.npmtrends.com/@hishprorg/est-qui-aperiam)
[![tests](https://github.com/hishprorg/est-qui-aperiam/actions/workflows/test.yml/badge.svg)](https://github.com/hishprorg/est-qui-aperiam/actions/workflows/test.yml)
...
```
npm install @hishprorg/est-qui-aperiam
```
...
```js
var cpx = require("@hishprorg/est-qui-aperiam");
```
...
[GitHub Releases](https://github.com/hishprorg/est-qui-aperiam/releases)
